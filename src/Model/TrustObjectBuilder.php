...
/**
 * Builder class for a TRUST object
 * version 20151021
 *
 * author: Mouaz AL Qudsi
 */
class TrustObjectBuilder extends ReferencingRemoteObjectBuilder
{
	...
	public function build()
	{
		...
		if($this->targetGID != "" && !GID::isValid($this->targetGID))
			throw new IllegalModelStateException('Invalid targetGID');
		...
		$trust = new TrustObject($this);

		if($trust->getSignature() == NULL)
			$trust->signObject();

		if(!$trust->verifyObjectSignature())
